package com.vietnq.heart_detection.model;/* Copyright 2016 The TensorFlow Authors. All Rights Reserved.
...
//        }
    ...
    @Override
    public List<Recognition> recognizeImage(final byte[] byteValues) {
